...
class _FavoriteScreenState extends State<FavoriteScreen> {
  ...
  Future<void> removeFavorite(FavoriteModel isFavorite, String dogId) async {
    _ui.loadState(true);
    try {
      ...
      return Container(
        child: RefreshIndicator(
          ...
          child: SingleChildScrollView(
            ...
            child: authVM.favoriteDog == null
                ? Column(
                    children: [
                      Center(child: Text("Something went wrong")),
                    ],
                  )
                : authVM.favoriteDog!.length == 0
                    ? Column(
                        children: [
                    ...
                    : Column(children: [
                        ...
                        ...authVM.favoriteDog!.map(
                          (e) => InkWell(
                            onTap: () {
                              Navigator.of(context)
                                  .pushNamed("/SubPage", arguments: e.dogId!);
                            },
                            child: Container(
                              ...
                              child: Card(
                                child: ListTile(
                                  ...
                                  title: Text(e.dogName.toString()),
                                  subtitle: Text(e.estimatedPrice.toString()),
                                ),
                              ),
                            ),
                          ),
